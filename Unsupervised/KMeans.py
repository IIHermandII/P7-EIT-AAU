...
# Plot the points with the cluster centers
# plt.figure(figsize=(10, 8))
# plt.scatter(X_pca[:, 0], X_pca[:, 1], c=y_pred, cmap='viridis', marker='o', edgecolor='k')
...
with PdfPages('KMeansAllData.pdf') as pdf:
    # for i, (metric, score_list) in enumerate(scores.items()):
    #     fig, ax = plt.subplots()
    #     ax.plot(clusters, score_list, marker='o', linestyle='-')
    ...
    ax.set_title(f'KMeans Clustering with {n_clusters} Clusters', size=24)
